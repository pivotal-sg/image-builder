...
RUN sudo -H -i -u ubuntu nvm alias default 5.7.0
RUN ["sudo", "/bin/bash", "-lc", "nvm alias default 5.7.0"]
...
RUN sudo -H -i -u ubuntu rvm use 2.3.0 --default
RUN ["/bin/bash", "-lc", "rvm use 2.3.0 --default"]
